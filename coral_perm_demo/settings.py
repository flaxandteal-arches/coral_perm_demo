"""
Django settings for coral_perm_demo project.
"""
...
DATATYPE_LOCATIONS.append("coral_perm_demo.datatypes")
FUNCTION_LOCATIONS.append("coral_perm_demo.functions")
ETL_MODULE_LOCATIONS.append("coral_perm_demo.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("coral_perm_demo.search_components")
...
SECRET_KEY = "django-insecure-fn@c$-754mfby_^hept_u=hp3#iup#hh6er5n4$u4a&zwq#l5)"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "coral_perm_demo.urls"
ROOT_HOSTCONF = "coral_perm_demo.hosts"

DEFAULT_HOST = "coral_perm_demo"
...
ELASTICSEARCH_PREFIX = "coral_perm_demo"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'coral_perm_demo.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "coral_perm_demo",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "coral_perm_demo.wsgi.application"
...
SESSION_COOKIE_NAME = "coral_perm_demo"
...
# ES_MAPPING_MODIFIER_CLASSES = ["coral_perm_demo.search.es_mapping_modifier.EsMappingModifier"]
